   ...
   public class FranchiseRegistrationViewModel: ModelBase
    ...
    { 
        ...
        public FranchiseRegistrationViewModel(INavigation navigation)
        {
            ...
            FranchiseMasters_Classs = new FranchiseMasters() { FranchiseAadharNo="",FranchiseAadharPhoto="",City_Name="", Franchise_Address="", Franchise_EmailId="",
        ...
        [Required]
        [StringLength(maximumLength: 16, ErrorMessage = "Adhar Number should be required Minimum 12 and maximum 16 number.", MinimumLength = 12)]
