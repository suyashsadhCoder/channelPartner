...
namespace ChannelPartner.Controls
{
    public class MpEntry : Entry, IControlValidation
    {
        ...
        public void CheckValidation()
        {
            ...
            this.PlaceholderColor = Color.FromHex("#777777");
            if (this.BindingContext != null && this.BindingContext is INotifyDataErrorInfo)
            {
                ...
                var _properties = _propertiesFieldInfo
                                 .GetValue(this) as System.Collections.IList;
        ...
        private void SetPlaceHolder()
        {
            if (!string.IsNullOrEmpty(BindingPath) && this.BindingContext != null)
            {
                ...
                if (_attributes != null)
                {
                    //this.PlaceholderTextColor = Color.FromHex("#727272");
                    //this.PlaceholderColor =Color.FromHex("#727272");
                    this.Placeholder = "Enter " + _attributes.Name; // assign placeholder property
                                                                    // this.SetPlaceHolder();
                                                                    //UIHintAttribute uIHintAttribute = _attributes.Name;
                }
            }
        }
        #endregion
